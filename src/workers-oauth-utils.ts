...
// From: https://github.com/cloudflare/ai/tree/main/demos/remote-mcp-github-oauth
...
<style>
:root{--primary-color:#0070f3;--border-color:#e5e7eb;--text-color:#333;--background-color:#fff;--card-shadow:0 8px 36px 8px rgba(0,0,0,0.1)}
...
@media(max-width:640px){.container{margin:1rem auto;padding:0.5rem}.card{padding:1.5rem}.client-detail{flex-direction:column}.detail-label{min-width:unset;margin-bottom:0.25rem}.actions{flex-direction:column}.button{width:100%}}
</style>
</head>
<body>
<div class="container">
<div class="precard">
<div class="header">${logoUrl ? `<img src="${logoUrl}" alt="${serverName} Logo" class="logo">` : ""}
